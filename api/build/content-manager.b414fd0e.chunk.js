(self["webpackChunkapi"] = self["webpackChunkapi"] || []).push([[994],{
  ...
  (0,immer_esm/* default */.ZP)(state, (draftState) => {
    ...
    switch (action.type) {
      ...
      case "ON_ADD_FIELD": {
        ...
        const type = get_default()(newState, ["modifiedData", "attributes", action.name, "type"], "");
...
const useContentManagerInitData = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      } = await get(utils_getRequestUrl("init"), { cancelToken: source.token });
      notifyStatus(
        formatMessage({
